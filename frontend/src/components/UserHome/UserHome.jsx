            ...
            <Row className="user-home-cards container">
              ...
              <Col>
                <Card style={{ width: "27rem" }}>
                  ...
                  <Card.Body>
                    <Card.Title>Interactive Coding Compiler</Card.Title>
                    <Card.Text>
                      Interactive coding compilers allows you to write, run, 
                      and test code directly in the web browser, without the need to download or 
                      install any software to practice your programming skills.
                    </Card.Text>
